...
def parse_opt():
    ...
    parser.add_argument('--dropout', type=float, default=0.2, help='dropout share in model')
    parser.add_argument('--units2', type=int, default=4096, help='number of hidden units in second to last last dense layer before output layer. Only applies if >0. If >0 units1 must also be >0')
    parser.add_argument('--units1', type=int, default=2048, help='number of hidden units in last last dense layer before output layer. Only applies if >0')
